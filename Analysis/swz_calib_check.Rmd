...
ggsave(filename = "/gpfs/data/bershteynlab/EMOD/citrod01/SWZ_calib/Analysis/HIV_mean_age_15.pdf",
       width = 6, height = 4, units = "in")
```
...
```{r}
art.coverage.shims <- read.csv(file = "/gpfs/data/bershteynlab/EMOD/citrod01/SWZ_calib/Analysis/SWZ_ART_SHIMS.csv")
...
art.coverage.shims %>% arrange(year, gender, AgeMin)
```
