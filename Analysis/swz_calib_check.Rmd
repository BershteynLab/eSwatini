...
results_path = "/gpfs/data/bershteynlab/EMOD/citrod01/SWZ_calib/test3_swz2024/Baseline-campaign_20240707-baseline/ReportHIVByAgeAndGender/"
...
mean.age.plhiv.dat <- data.table(Year = c(2007, 2011, 2017, 2021), 
          ...
          mean.age.plhiv.1549.UL = c(33.44926051, 35.35714126, 36.1376078, 38.38177236,
                                     29.53683457, 31.36407194, 33.9604742, 34.85016587)
)
```
...
p <- Infected.by.age.15.49 %>% 
  filter(Year >= 2000) %>% 
  mutate(Gender = factor(Gender, labels = c("Male", "Female")))  %>%
  ggplot() + 
  geom_line(mapping = aes(x = Year, y = prod, color = Gender), size = 2, show.legend = FALSE) + 
  theme_bw(base_size=16) +
  guides(fill = guide_legend(keywidth = 2, keyheight = 1)) +
...
ggsave(filename = "/gpfs/data/bershteynlab/EMOD/citrod01/SWZ_calib/Analysis/HIV_mean_age_1549_compare.pdf",
       width = 6, height = 4 , units = "in")
